...
| Public specification-repository target changed during handoff | Bound clone and status text to `selamy-labs/antigravity-behavior-engineering`; transfer and initial push remain external operations |
