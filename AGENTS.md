...
6. `docs/decisions/` and `handoff/ralph-execution-contract.md`
...
- One task equals one branch and one PR. Branch:
  `ralph/TNNN-<task-title-kebab-case>`. PR title:
...
- Do not bulk-run Spec Kit implementation. The Ralph contract selects and
...
T001, and again at T038 or T045, stage the packet, set Ralph state to
`needs_human`, and surface the exact requested action.
